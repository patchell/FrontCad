...
BEGIN_MESSAGE_MAP(CFrontCadView, CChildViewBase)
	...
	ON_COMMAND(ID_HOLE_ROUNDHOLE1FLAT, &CFrontCadView::OnDrawRoundholewith1flat)
	ON_UPDATE_COMMAND_UI(ID_DRAW_ROUNDHOLEWITH1FLAT, &CFrontCadView::OnUpdateDrawRoundholewith1flat)
	ON_COMMAND(ID_HOLE_ROUNDHOLE2FLATS, &CFrontCadView::OnDrawRoundholewith2flats)
	ON_UPDATE_COMMAND_UI(ID_HOLE_ROUNDHOLE2FLATS, &CFrontCadView::OnUpdateDrawRoundholewith2flats)
